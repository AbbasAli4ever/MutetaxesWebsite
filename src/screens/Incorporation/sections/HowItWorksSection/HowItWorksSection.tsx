  ...
  return (
    <section className="relative w-full py-8">
      ...
      <div className="relative w-full max-w-[1440px] mx-auto mt-[120px] px-4">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              >
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[26px] flex items-center justify-center [font-family:'Helvetica_Neue-Medium',Helvetica] font-medium text-[black] text-[17.6px] text-center tracking-[0] leading-[37px] whitespace-nowrap">
                  {step.number}
                </div>
              </div>
              ...
              >
                <CardContent
                  className={`relative w-[300px] h-[300px] flex flex-col`}
                >
                  <img
                    src={step.background}
                    alt=""
                  ...
                  <div className="relative z-10 flex flex-col py-5 pl-0">
                    <div
                      className={`h-auto flex ${
                        step.alignment === "right"
                          ? "justify-center ml-12 mt-2"
                          : "justify-start mt-2"
                      } [font-family:'Helvetica_Neue-Medium',Helvetica] font-medium text-[#212833] text-[22px] tracking-[0] leading-[23px] whitespace-pre-wrap`}
                    >
                      {step.title}
                    </div>
                    <ul className="mt-[23px] flex flex-col gap-3"> {step.items.map((item, itemIndex) => ( <li key={itemIndex} className="flex items-center gap-2.5" > <img className="flex-shrink-0 w-6 h-6" alt="Check" src="/Incorporate/frame.svg" /> <span className="[font-family:'Helvetica_Neue-Regular',Helvetica] font-normal text-[#212833e6] text-sm tracking-[0] leading-[18.5px]"> {item} </span> </li> ))} </ul>
                  </div>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="flex justify-center mt-[121px]">
