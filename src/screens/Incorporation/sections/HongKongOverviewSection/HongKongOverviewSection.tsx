    ...
    <section className="flex flex-col w-full gap-10 py-8 mt-[100px]">
      <header className="flex flex-col items-center gap-4 px-4 max-w-[1016px] mx-auto">
        <div className="flex flex-col items-center w-full gap-4">
          ...
          <h1 className="[font-family:'Georgia-Regular',Helvetica] font-normal text-[#212833] text-[64px] text-center tracking-[0] leading-[72px]">
            Choose Your Incorporation Package
          </h1>
        </div>

        <p className="[font-family:'Helvetica_Neue-Regular',Helvetica] font-normal text-[#212833] text-[22px] text-center tracking-[-0.64px] leading-[35px] max-w-[702px]">
          We help you select the optimal structure for your business goals
        </p>
      </header>

      <div className="relative flex items-start justify-center gap-6 px-4 max-w-[1140px] mx-auto w-full">
              ...
              <CardContent className="relative flex flex-col h-full p-6">
                <div className="flex flex-col gap-5">
                  <div className="flex flex-col gap-4">
                    <div className="text-[#222222] [font-family:'Helvetica_Neue-Medium',Helvetica] font-medium text-[54.2px] tracking-[0] leading-[normal]">
                      {tier.price}
                    </div>
                  </div>

                  <div className="flex flex-col gap-[7px]">
                    <h3 className="[font-family:'Helvetica_Neue-Medium',Helvetica] font-medium text-[#222222] text-2xl tracking-[0] leading-7">
                      {tier.title}
                    </h3>
                        ...
                        >
                          ...
                          >
                            ...
                            {feature.included && (
                              <>
                                {" "}
                                <span className="[font-family:'Helvetica_Neue-Medium',Helvetica] font-medium text-[#004eff]">
                                  {feature.included}
                                </span>
                              </>
                            )}
                ...
                <div className="flex flex-col items-center gap-3 mt-auto">
                  ...
                  <div className="[font-family:'Helvetica_Neue-Regular',Helvetica] font-normal text-[#212833e6] text-base tracking-[0] leading-[18.5px]">
                    <span>Supprot: </span>
