...
import { Input } from "../../../../IncorporateComponents/ui/input";
import { Separator } from "../../../../IncorporateComponents/ui/separator";
      ...
      <footer className="flex flex-col items-start gap-[19px] pt-12 pb-3.5 px-[100px] w-full bg-[#212833] rounded-3xl overflow-hidden">
        <div className="flex items-center justify-between w-full">
          <div className="flex flex-col w-[682.5px] items-start justify-center gap-[11px]">
            <img
              ...
              alt="Mutetaxes logo"
              src="/Incorporate/mutetaxes-logo-1-1.svg"
            />
          ...
          <div className="inline-flex items-start gap-[58px]">
            ...
            <div className="flex flex-col w-[268px] items-start gap-4 self-stretch">
              ...
              <div className="flex flex-col items-start w-full gap-3">
                ...
                <Button className="h-9 w-full bg-[#004eff] rounded-[146px] shadow-[0px_1px_2px_-1px_#0000001a,0px_1px_3px_#0000001a] hover:bg-[#0040cc] [font-family:'Segoe_UI-Regular',Helvetica] font-normal text-white text-sm text-center tracking-[0] leading-5">
                  Subscribe
                </Button>
              </div>
            </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-[0px_24px] w-full">
          {certifications.map((cert, index) => (
            <div key={index} className="inline-flex items-center">
              <img className="w-6 h-4" alt="Svg margin" src="/Incorporate/svg-margin.svg" />
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <img
            ...
            alt="Social media"
            src="/Incorporate/social-media.svg"
          />
        </div>
      </footer>
    </div>
