      ...
      <span className="font-georgia font-normal text-[#004eff] text-[36px] md:text-[36px] lg:text-[70px] whitespace-nowrap">
        Hong Kong
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row">
            <Button className="group h-auto gap-[10px] sm:gap-[35px] pl-3 pr-1.5 py-2 rounded-[100px] bg-[linear-gradient(131deg,rgba(104,150,255,1)_0%,rgba(0,78,255,1)_100%)] hover:opacity-90">
              <span className="font-helvetica font-medium text-white text-sm sm:text-base text-center tracking-[0] leading-6">
