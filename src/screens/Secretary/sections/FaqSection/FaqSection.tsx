...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "../../../../SacretaryComponents/ui/accordion";
    ...
    <section className="flex flex-col w-full items-center gap-10 px-4 md:px-[120px] py-8">
      <div className="flex flex-col w-full max-w-[952px] items-center gap-4">
        <div className="flex flex-col items-start w-full gap-4">
          ...
          <h2 className="flex items-center justify-center w-full [font-family:'Georgia-Regular',Helvetica] font-normal text-[#212833] text-4xl md:text-[64px] text-center tracking-[0] leading-tight md:leading-[72px]">
            Company Secretary FAQs
          </h2>
        </div>
      </div>

      <div className="flex flex-col items-center gap-4 w-full max-w-[988px]">
        <Accordion
          type="single"
          collapsible
