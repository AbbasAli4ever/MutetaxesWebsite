...
export const Step1CompanyInfo: React.FC<Step1Props> = ({ data, onChange }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <label className="block text-sm font-medium text-[#212833]">
          Proposed Company Name (English) <span className="text-red-500">*</span>
        </label>
        <Input
          type="text"
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          onChange={(e) => onChange({ businessScopeDescription: e.target.value })}
          className="bg-[#f5f7fa] border-gray-300 min-h-[100px]"
        />
      </div>

      {/* Company Type */}
      <div className="space-y-2">
        <label className="block text-sm font-medium text-[#212833]">Company Type</label>
        <Input
          type="text"
