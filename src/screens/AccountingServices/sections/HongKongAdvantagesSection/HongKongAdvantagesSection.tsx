      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-center gap-6 px-4 max-w-[1300px] mx-auto w-full">
        {pricingData.map((plan, index) => (
          <div key={index} className="relative w-full max-w-[330px]">
            ...
            <Card
              className={`relative w-full h-auto min-h-[710px] rounded-[20px] flex flex-col border-0 overflow-hidden ${plan.featured
            ...
            >
              ...
              <CardContent className="relative z-10 flex flex-col h-full p-6">
                <div className="flex flex-col gap-5 mb-10">
                  <div className="flex flex-col gap-4">
                    <div
                      className={`font-helvetica font-medium text-[40.2px] tracking-[0] leading-[normal] ${plan.featured ? "text-[#004eff]" : "text-[#222222]"
                        }`}
                    >
                      {plan.price}
              ...
              <div className="absolute z-10 flex-col items-center justify-center w-full mt-auto bottom-10">
                <Button
                  ...
                  className={`h-auto w-[217px] rounded-[28.01px] py-[15px] px-6 ${plan.featured
