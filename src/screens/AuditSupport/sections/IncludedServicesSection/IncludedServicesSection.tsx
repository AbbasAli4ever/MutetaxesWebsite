    ...
    content: (
      <>
        <span className="font-medium">
          All Hong Kong Companies Must Be Audited Annually.
        </span>
            ...
            <CardContent className="p-0 relative h-[408px]">
              ...
              {card.id === 1 && (
                <div className="flex w-[344px] gap-8 top-32 left-[25px] flex-col items-start absolute">
                  <h3 className="relative flex items-center justify-center self-stretch mt-[-1.22px] [font-family:'Helvetica_Neue-Medium',Helvetica] font-medium text-[#212833] text-2xl tracking-[0] leading-[34.1px]">
                    {card.title}
                  </h3>
                ...
                <div className="inline-flex gap-8 top-[124px] left-[26px] flex-col items-start absolute">
                  ...
                  <div className="flex flex-col w-[344px] items-start gap-6 relative flex-[0_0_auto]">
                    <div className="flex w-[344px] items-center gap-2.5 relative flex-[0_0_auto]">
                      <p className="relative flex items-center justify-center w-[310px] mt-[-1.00px] [font-family:'Helvetica_Neue-Regular',Helvetica] font-normal text-[#212833e6] text-xl tracking-[0] leading-8">
                    ...
                    {checklistItems.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="relative flex items-center justify-center w-[310px] [font-family:'Helvetica_Neue-Regular',Helvetica] font-normal text-[#212833e6] text-xl tracking-[0] leading-8">
                          {item.text}
                        </div>
                      </div>
                    ))}
