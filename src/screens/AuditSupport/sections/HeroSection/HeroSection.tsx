...
export const HeroSection = (): JSX.Element => {
  const statisticsBadges = [
  {
    ...
    className: "bottom-[1%] sm:bottom-[10%] left-[2%] md:left-[8%] xl:left-[28%] rounded-l-[14.12px] rounded-br-[14.12px]",
...

  {
    ...
    className: "bottom-[2%] sm:bottom-[12%] left-[60%] md:left-[60%] xl:left-[62%] rounded-r-[14.12px] rounded-bl-[14.12px]",
    shadow: "shadow-[0px_11.91px_22.12px_#004eff52]",
  },
];
  return (
