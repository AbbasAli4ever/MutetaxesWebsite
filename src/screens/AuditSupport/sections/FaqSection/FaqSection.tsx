...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "../../../../AuditComponents/ui/accordion";
...
export const FaqSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full items-center gap-10 px-[120px] py-8 relative">
      ...
      <div className="inline-flex flex-col gap-4 relative items-center w-full max-w-[988px]">
        <Accordion
          type="single"
          collapsible
        ...
        >
          {faqItems.map((item) => (
            ...
            >
              <AccordionTrigger className="flex items-center gap-4 p-6 hover:no-underline [&[data-state=open]>svg]:rotate-180">
              ...
              <AccordionContent className="px-6 pb-6"></AccordionContent>
            </AccordionItem>
          ))}
        </Accordion>
      </div>
