...
export const FaqSection = (): JSX.Element => {
  return (
    <section className="flex flex-col mt-0 lg:mt-[100px] w-full items-center gap-8 sm:gap-10 md:gap-12 px-4 sm:px-6 md:px-12 lg:px-20 xl:px-[120px] py-10 sm:py-12 md:py-16 relative">
      {/* Header */}
